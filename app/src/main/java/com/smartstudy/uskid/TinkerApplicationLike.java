...
import com.smartstudy.uskid.tinker.Log.MyLogImp;
import com.smartstudy.uskid.tinker.util.TinkerManager;
...
@DefaultLifeCycle(application = "com.smartstudy.uskid.MyApplication",// application类名。只能用字符串，这个MyApplication文件是不存在的，但可以在AndroidManifest.xml的application标签上使用（name）
